...
<head>
    <title>Code coverage report for server/router/generic.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">server/router</a> generic.js</h1>
        <div class='clearfix'>
...
<a name='L37'></a><a href='#L37'>37</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">27x</span>
...
&nbsp;
  return async ctx =&gt; {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (ctx.req.solved) <span class="cstat-no" title="statement not covered" >return;</span>
&nbsp;
...
&nbsp;
    ...
    await join(middle, ctx =&gt; {
      ...
      ctx.req.solved = true;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!ctx.res.headersSent) {
        ctx.res.end();
      }
    })(ctx);
  };
