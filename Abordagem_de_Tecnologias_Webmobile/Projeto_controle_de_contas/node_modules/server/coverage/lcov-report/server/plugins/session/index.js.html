...
<head>
    <title>Code coverage report for server/plugins/session/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">server/plugins/session</a> index.js</h1>
        <div class='clearfix'>
...
<a name='L50'></a><a href='#L50'>50</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">27x</span>
...
module.exports = {
  ...
  init: ctx =&gt; {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!ctx.options.session.store &amp;&amp; ctx.options.session.redis) {
      const redisClient = <span class="cstat-no" title="statement not covered" >new Redis(ctx.options.session.redis);</span>
<span class="cstat-no" title="statement not covered" >      ctx.options.session.store = new RedisStore({ client: redisClient });</span>
    }
  ...
  launch: ctx =&gt; {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!ctx.io || !ctx.io.use) <span class="cstat-no" title="statement not covered" >return;</span>
