...
<head>
    <title>Code coverage report for server/plugins/express/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">server/plugins/express</a> index.js</h1>
        <div class='clearfix'>
...
<a name='L84'></a><a href='#L84'>84</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">27x</span>
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (path.resolve(ctx.options.views) === path.resolve(process.cwd())) {
