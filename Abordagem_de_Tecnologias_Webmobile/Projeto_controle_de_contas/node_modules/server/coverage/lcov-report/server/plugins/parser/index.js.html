...
<head>
    <title>Code coverage report for server/plugins/parser/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">server/plugins/parser</a> index.js</h1>
        <div class='clearfix'>
...
const plugin = {
  ...
  options: {
    ...
    method: {
      ...
      clean: value =&gt; typeof value === 'string' ? <span class="branch-0 cbranch-no" title="branch not covered" >[value] </span>: value
    }
  },
&nbsp;
...
&nbsp;
    ctx =&gt; {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!ctx.options.parser.body) <span class="cstat-no" title="statement not covered" >return;</span>
...
&nbsp;
    // JSON parser
    ctx =&gt; {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!ctx.options.parser.json) <span class="cstat-no" title="statement not covered" >return;</span>
