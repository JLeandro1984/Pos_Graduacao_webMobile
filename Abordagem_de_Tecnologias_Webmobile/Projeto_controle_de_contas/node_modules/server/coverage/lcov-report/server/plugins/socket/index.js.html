...
<head>
    <title>Code coverage report for server/plugins/socket/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">server/plugins/socket</a> index.js</h1>
        <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >    listeners[path].push(middle);</span>
  ...
  launch: ctx =&gt; {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (listeners.ping) {
<span class="cstat-no" title="statement not covered" >      ctx.log.warning('socket("ping") has a special meaning, please avoid it');</span>
    }
    ...
    ctx.io.on('connect', <span class="fstat-no" title="function not covered" >so</span>cket =&gt; {
      ...
      const createContext = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >ex</span>tra =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        return Object.assign({}, socket.client.request, ctx, extra);</span>
      };
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            socket.on(path, <span class="fstat-no" title="function not covered" >da</span>ta =&gt; <span class="cstat-no" title="statement not covered" >cb(createContext({ path, socket, data })))</span>;</span>
          });
        }
      }
&nbsp;
      ...
      const path = <span class="cstat-no" title="statement not covered" >'connect';</span>
<span class="cstat-no" title="statement not covered" >      if (listeners['connect']) {</span>
<span class="cstat-no" title="statement not covered" >        listeners[path].forEach(<span class="fstat-no" title="function not covered" >cb</span> =&gt; <span class="cstat-no" title="statement not covered" >cb(createContext({ path, socket })))</span>;</span>
      }
    });
  }
};
